  ...
  return (
    <div className="App">
      <section class="row video-container" >
        {/* <ReactPlayer url={aUrl} muted={true} controls={true} playIcon /> */}{/* <ReactPlayer url={aUrl} muted={true} controls={true} playIcon={true} playing={true} light={<img src={'img/jake.gif'} alt='Thumbnail' />} /> */}
      </section>
      <section class="row video-container" >
      ...
      <div class="row tm-mb-90 tm-gallery  ml-2 mr-2">
        {
          tutorials.map((a) => (<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
            <figure class="effect-ming tiles">
              <img src={a.thumbnail} alt={a.title + ' image'} />
